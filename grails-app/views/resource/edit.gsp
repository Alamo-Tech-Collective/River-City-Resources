        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><g:link action="show" id="${this.resource?.id}">Show</g:link></li>
                    <li class="breadcrumb-item active" aria-current="page"><g:message code="default.edit.label" args="[entityName]" /></li>
                </ol>
            </nav>
            <section class="row">
                <div id="edit-resource" class="col-12 content scaffold-edit" role="main">
                    ...
                    <g:form resource="${this.resource}" method="PUT" role="form" aria-label="Edit resource form">
                        <g:hiddenField name="version" value="${this.resource?.version}" />
                        <fieldset class="form">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <g:render template="/_fields/resource/eligibilityRequirements/wrapper" model="[value: resource?.eligibilityRequirements]"/>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset class="buttons mt-4">
                            ...
                            <g:link action="show" id="${this.resource?.id}" class="btn btn-secondary ml-2" aria-label="Cancel and view resource details">Cancel</g:link>
                            <g:link action="index" class="btn btn-outline-secondary ml-2" aria-label="Return to resource list">Back to List</g:link>
                            <div id="update-help" class="form-text mt-2">Update the resource with the changes made above.</div>
                        </fieldset>
                    </g:form>
                </div>
            </section>
