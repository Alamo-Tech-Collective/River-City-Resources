        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><g:link action="show" id="${this.category?.id}">Show</g:link></li>
            ...
            <section class="row">
                <div id="edit-category" class="col-12 content scaffold-edit" role="main">
                    ...
                    <g:form resource="${this.category}" method="PUT" role="form" aria-label="Edit category form">
                        ...
                        <fieldset class="buttons mt-4">
                            ...
                            <g:link action="show" id="${this.category?.id}" class="btn btn-secondary ml-2" aria-label="Cancel and view category details">Cancel</g:link>
                            <g:link action="index" class="btn btn-outline-secondary ml-2" aria-label="Return to category list">Back to List</g:link>
                            <div id="update-help" class="form-text mt-2">Update the category with the changes made above.</div>
                        </fieldset>
                    </g:form>
                </div>
            </section>
